...
+ (NSData *)dataFromBase64String:(NSString *)aString
{
    ...
    void *outputBuffer = [self NewBase64Decode:[data bytes]
                                                size:[data length]
                                                len:&outputLength];
//    NewBase64Decode([data bytes], [data length], &outputLength);
...
- (NSString *)base64EncodedString
{
    size_t outputLength;
    char *outputBuffer =
    [self NewBase64Encode:[self bytes] s:YES size:[self length] len:&outputLength];
